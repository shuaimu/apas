...
mod tests {
    ...
    fn tech_lead_prompt_guards_auto_merge_safeguards() {
        ...
        for needle in [
            ...
            "escalate once with the affected PR URL list",
            "leave later eligible PRs in that same repo open",
            "until the setting changes or the prior escalation is no longer recent",
            "Be conservative",
